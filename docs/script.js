let long;
let lat;
let temperatureDescription = document.querySelectorAll(".temperature-description");
let temperatureDegree = document.querySelectorAll(".temperature-degree");
let locationTimezone= document.querySelectorAll(".location-timezone");
let setIcon = document.querySelector(".icon");
let maxTemperature = document.querySelectorAll(".maxTemp");
let minTemperature = document.querySelectorAll(".minTemp");
